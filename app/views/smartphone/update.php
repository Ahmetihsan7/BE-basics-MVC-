        ...
        <div class="col-6">
            <form action="<?= URLROOT; ?>/SmartphoneController/update" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="megapixels" type="number" min="0" max="1000"
                        class="form-control" id="megapixels"
